...
<h3 align="center">Software Engineer | AI & NLP Developer</h3>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=arsali03&label=Profile%20views&color=0e75b6&style=flat-square" alt="arsali03" />
</p>

---

### 💫 About Me:
- 🔭 I’m currently working as an **AI Developer** on R&D projects (including TÜBİTAK-supported NLP and Location Tracking systems).
- 🧠 Specializing in **Natural Language Processing (NLP)**, Transformer-based models, NER (BIO Tagging), and Sentiment Analysis.
- ⚙️ Building scalable **MLOps pipelines**, automating model training with Celery/Redis, and designing microservices with **FastAPI** & **Docker**.
- 🌱 Always exploring advanced embedding techniques and LLM optimizations.
- 📫 How to reach me: **33.arsali.33@gmail.com**

> 🔒 **Note on my GitHub Activity:** > While I love open-source, the majority of my most advanced and recent work (including enterprise AI models, complex NLP pipelines, and R&D projects) resides in **private repositories** due to strict confidentiality and non-disclosure agreements (NDAs).
